    ...
    <>
      <div className="flex gap-2 items-center">
        <button
          ...
          type="button"
          className="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-50 hover:text-pink-500 dark:hover:bg-slate-700 rounded text-base">
        ...
        <ul className={isOpened ? "flex gap-1 uppercase" : "hidden"}>
