        ...
        <div className="relative">
          <div className="absolute">
            <div className="">
              ...
              <Link href="/" className="inline-block my-2 rounded py-4 px-8 text-center bg-indigo-600 text-white hover:bg-indigo-100 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50">
                Take me there!
              </Link>
            </div>
          </div>
